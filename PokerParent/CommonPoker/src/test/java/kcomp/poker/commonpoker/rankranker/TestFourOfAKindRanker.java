...
public class TestFourOfAKindRanker extends BaseTestRanker {

	@Before
	public void init() {
		ranker = new FourOfAKindRanker();
	}
	...
	public void test_happy_path() throws HandRankException {
		...
		assertTrue(handValue.getHandRank().equals(HandRank.FOUR_OF_A_KIND));
	}

	@Test
	public void test_happy_path_7_cards() throws HandRankException {

		Hand hand = HandCreator.createFourKindHand(Rank.ACE, Rank.KING);
	...
	public void test_happy_path_5_cards_rank_check() throws HandRankException {
		...
		assertEquals(Rank.KING, kickers.get(0).getRank());
	}
	...
	public void test_happy_path_7_cards_main_kicker_size() throws HandRankException {
		...
		assertEquals(4, mainCards.size());

		assertEquals(1, kickers.size());
	}

	@Test
	public void test_not_4_kind_should_return_high_card() throws HandRankException {
